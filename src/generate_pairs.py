    ...
    def _generate_mismatches_pairs(self):
        ...
        for i, name in enumerate(os.listdir(self.data_dir)):
            ...
            for item in remaining:
                if not os.path.isdir(self.data_dir + item):
...
def parse_arguments(argv):
    ...
    parser.add_argument('--data_dir', type=str, help='Directory with aligned images.', default='E:/test_align_lfw_rename/')
    parser.add_argument('--save_dir', type=str, help='Directory to save pairs.', default='D:/Python/work/facenet-master_notwork/data/')
