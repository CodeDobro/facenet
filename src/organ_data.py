...
def parse_arguments(argv):
    ...
    parser.add_argument('--data_dir', type=str, help='Directory with aligned images.', default='E:/test_align/')
    parser.add_argument('--save_dir', type=str, help='Directory to save renamed images.', default='E:/test_align_rename/')
